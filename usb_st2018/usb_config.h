...
//  a const USB_CTRLDEVICE_DESCRIPTOR variable by the exact name of device_dsc
//  must exist.
#define USB_USER_CTRLDEVICE_DESCRIPTOR &device_dsc
#define USB_USER_CTRLDEVICE_DESCRIPTOR_INCLUDE extern const USB_CTRLDEVICE_DESCRIPTOR device_dsc
