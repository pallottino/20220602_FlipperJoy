 ...
 */
#define USB_HAL_CTRLDEV_CONN_FULL_SPD       USB_HAL_PULL_UP_D_PLUS
#define USB_HAL_CTRLDEV_CONN_LOW_SPD        USB_HAL_PULL_UP_D_MINUS
#define USB_HAL_CTRLDEV_DISCONNECT          0
...
/*************************************************************************
    ...
    Parameters:
        ep_num - Number of endpoint to configure, Must be
                 (ep_num >=0) && (ep_num <= USB_CTRLDEV_HIGHEST_EP_NUMBER)
