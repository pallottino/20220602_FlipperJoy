...
#ifndef _USB_CTRLDEVICE_H
#define _USB_CTRLDEVICE_H
...
typedef enum
{
    ...
    EVENT_CONFIGURED
    /*DOM-IGNORE-BEGIN*/    = EVENT_CTRLDEVICE_STACK_BASE        /*DOM-IGNORE-END*/,
...
/***************************************************************************
  Function:
        USB_CTRLDEVICE_STATE USBGetDeviceState(void)
  ...
  Conditions:
    None
  Return Values:
    USB_CTRLDEVICE_STATE - the current state of the device on the bus
...
/*******************************************************************************
  ...
  Input:
    ...
    uint8_t event   -  The event input specifies which event happened.  The
                    possible options are listed in the USB_CTRLDEVICE_STACK_EVENTS
                    enumeration.
...
extern USB_VOLATILE USB_CTRLDEVICE_STATE USBDeviceState;
