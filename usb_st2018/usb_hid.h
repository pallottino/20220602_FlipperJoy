...
typedef enum
{
    ...
    USB_HID_USAGE_PAGE_GENERIC_CTRLDEVICE_CONTROLS                                  = 0x06,
    ...
    USB_HID_USAGE_PAGE_POWER_CTRLDEVICE                                             = 0x84,
    ...
    USB_HID_USAGE_PAGE_WEIGHING_CTRLDEVICES                                         = 0x8D,
    USB_HID_USAGE_PAGE_MAGNETIC_STRIPE_READING_CTRLDEVICES                          = 0x8E,
...
typedef enum
{
    ...
    USB_HID_SIMULATION_CONTROLS_FLIGHT_SIMULATION_CTRLDEVICE             = 0x01,
    USB_HID_SIMULATION_CONTROLS_AUTOMOBILE_SIMULATION_CTRLDEVICE         = 0x02,
    USB_HID_SIMULATION_CONTROLS_TANK_SIMULATION_CTRLDEVICE               = 0x03,
    USB_HID_SIMULATION_CONTROLS_SPACESHIP_SIMULATION_CTRLDEVICE          = 0x04,
    USB_HID_SIMULATION_CONTROLS_SUBMARINE_SIMULATION_CTRLDEVICE          = 0x05,
    USB_HID_SIMULATION_CONTROLS_SAILING_SIMULATION_CTRLDEVICE            = 0x06,
    USB_HID_SIMULATION_CONTROLS_MOTORCYCLE_SIMULATION_CTRLDEVICE         = 0x07,
    USB_HID_SIMULATION_CONTROLS_SPORTS_SIMLUATION_CTRLDEVICE             = 0x08,
    USB_HID_SIMULATION_CONTROLS_AIRPLANE_SIMULATION_CTRLDEVICE           = 0x09,
    USB_HID_SIMULATION_CONTROLS_HELICOPTER_SIMULATION_CTRLDEVICE         = 0x0A,
    USB_HID_SIMULATION_CONTROLS_MAGIC_CARPET_SIMULATION_CTRLDEVICE       = 0x0B,
    USB_HID_SIMULATION_CONTROLS_BICYCLE_SIMULATION_CTRLDEVICE            = 0x0C,
    /* Reserved                                                                 = 0x0D-0x1F */
...
typedef enum
{
    ...
    USB_HID_VR_CONTROLS_ANIMATRONIC_CTRLDEVICE                           = 0x0A,
    /* Reserved                                                                 = 0x0B-0x1F */
...
typedef enum
{
    ...
    USB_HID_GAME_CONTROLS_PINBALL_CTRLDEVICE                             = 0x02,
    USB_HID_GAME_CONTROLS_GUN_CTRLDEVICE                                 = 0x03,
    /* Reserved                                                                 = 0x04-0x1F */
...
typedef enum
{
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_UNIDENTIFIED                     = 0x00,
    /* Reserved                                                                 = 0x01-0x1F */
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_BATTERY_STRENGTH                 = 0x20,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_WIRELESS_CHANNEL                 = 0x21,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_WIRELESS_ID                      = 0x22,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_DISCOVER_WIRELESS_CONTROL        = 0x23,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_SECURITY_CODE_CHARACTER_ENTERED  = 0x24,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_SECURITY_CODE_CHARACTER_ERASED   = 0x25,
    USB_HID_GENERIC_CTRLDEVICE_CONTROLS_SECURITY_CODE_CLEARED            = 0x26
    /* Reserved                                                                 = 0x27-0xFFFF */
} USB_HID_GENERIC_CTRLDEVICE_CONTROLS;
...
typedef enum
{
    USB_HID_TELEPHONY_CTRLDEVICE_UNASSIGNED                              = 0x00,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE                                   = 0x01,
    USB_HID_TELEPHONY_CTRLDEVICE_ANSWERING_MACHINE                       = 0x02,
    USB_HID_TELEPHONY_CTRLDEVICE_MESSAGE_CONTROLS                        = 0x03,
    USB_HID_TELEPHONY_CTRLDEVICE_HANDSET                                 = 0x04,
    USB_HID_TELEPHONY_CTRLDEVICE_HEADSET                                 = 0x05,
    USB_HID_TELEPHONY_CTRLDEVICE_TELEPHONY_KEY_PAD                       = 0x06,
    USB_HID_TELEPHONY_CTRLDEVICE_PROGRAMMABLE_BUTTON                     = 0x07,
    /* Reserved                                                                 = 0x08-0x1F */
    USB_HID_TELEPHONY_CTRLDEVICE_HOOK_SWITCH                             = 0x20,
    USB_HID_TELEPHONY_CTRLDEVICE_FLASH                                   = 0x21,
    USB_HID_TELEPHONY_CTRLDEVICE_FEATURE                                 = 0x22,
    USB_HID_TELEPHONY_CTRLDEVICE_HOLD                                    = 0x23,
    USB_HID_TELEPHONY_CTRLDEVICE_REDIAL                                  = 0x24,
    USB_HID_TELEPHONY_CTRLDEVICE_TRANSFER                                = 0x25,
    USB_HID_TELEPHONY_CTRLDEVICE_DROP                                    = 0x26,
    USB_HID_TELEPHONY_CTRLDEVICE_PARK                                    = 0x27,
    USB_HID_TELEPHONY_CTRLDEVICE_FORWARD_CALLS                           = 0x28,
    USB_HID_TELEPHONY_CTRLDEVICE_ALTERNATE_FUNCTION                      = 0x29,
    USB_HID_TELEPHONY_CTRLDEVICE_LINE                                    = 0x2A,
    USB_HID_TELEPHONY_CTRLDEVICE_SPEAKER_PHONE                           = 0x2B,
    USB_HID_TELEPHONY_CTRLDEVICE_CONFERENCE                              = 0x2C,
    USB_HID_TELEPHONY_CTRLDEVICE_RING_ENABLE                             = 0x2D,
    USB_HID_TELEPHONY_CTRLDEVICE_RING_SELECT                             = 0x2E,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_MUTE                              = 0x2F,
    USB_HID_TELEPHONY_CTRLDEVICE_CALLER_ID                               = 0x30,
    USB_HID_TELEPHONY_CTRLDEVICE_SEND                                    = 0x31,
    /* Reserved                                                                 = 0x32-0x4F */
    USB_HID_TELEPHONY_CTRLDEVICE_SPEED_DIAL                              = 0x50,
    USB_HID_TELEPHONY_CTRLDEVICE_STORE_NUMBER                            = 0x51,
    USB_HID_TELEPHONY_CTRLDEVICE_RECALL_NUMBER                           = 0x52,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_DIRECTORY                         = 0x53,
    /* Reserved                                                                 = 0x54-0x6F */
    USB_HID_TELEPHONY_CTRLDEVICE_VOICE_MAIL                              = 0x70,
    USB_HID_TELEPHONY_CTRLDEVICE_SCREEN_CALLS                            = 0x71,
    USB_HID_TELEPHONY_CTRLDEVICE_DO_NOT_DISTURB                          = 0x72,
    USB_HID_TELEPHONY_CTRLDEVICE_MESSAGE                                 = 0x73,
    USB_HID_TELEPHONY_CTRLDEVICE_ANSWER_ON_OFF                           = 0x74,
    /* Reserved                                                                 = 0x75-0x8F */
    USB_HID_TELEPHONY_CTRLDEVICE_INSIDE_DIAL_TONE                        = 0x90,
    USB_HID_TELEPHONY_CTRLDEVICE_OUTSIDE_DIAL_TONE                       = 0x91,
    USB_HID_TELEPHONY_CTRLDEVICE_INSIDE_RING_TONE                        = 0x92,
    USB_HID_TELEPHONY_CTRLDEVICE_OUTSIDE_RING_TONE                       = 0x93,
    USB_HID_TELEPHONY_CTRLDEVICE_PRIORITY_RING_TONE                      = 0x94,
    USB_HID_TELEPHONY_CTRLDEVICE_INSIDE_RINGBACK                         = 0x95,
    USB_HID_TELEPHONY_CTRLDEVICE_PRIORITY_RINGBACK                       = 0x96,
    USB_HID_TELEPHONY_CTRLDEVICE_LINE_BUSY_TONE                          = 0x97,
    USB_HID_TELEPHONY_CTRLDEVICE_REORDER_TONE                            = 0x98,
    USB_HID_TELEPHONY_CTRLDEVICE_CALL_WAITING_TONE                       = 0x99,
    USB_HID_TELEPHONY_CTRLDEVICE_CONFIRMATION_TONE_1                     = 0x9A,
    USB_HID_TELEPHONY_CTRLDEVICE_CONFIRMATION_TONE_2                     = 0x9B,
    USB_HID_TELEPHONY_CTRLDEVICE_TONES_OFF                               = 0x9C,
    USB_HID_TELEPHONY_CTRLDEVICE_OUTSIDE_RINGBACK                        = 0x9D,
    USB_HID_TELEPHONY_CTRLDEVICE_RINGER                                  = 0x9E,
    /* Reserved                                                                 = 0x9F-0xAF */
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_0                             = 0xB0,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_1                             = 0xB1,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_2                             = 0xB2,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_3                             = 0xB3,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_4                             = 0xB4,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_5                             = 0xB5,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_6                             = 0xB6,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_7                             = 0xB7,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_8                             = 0xB8,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_9                             = 0xB9,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_STAR                          = 0xBA,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_POUND                         = 0xBB,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_A                             = 0xBC,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_B                             = 0xBD,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_C                             = 0xBE,
    USB_HID_TELEPHONY_CTRLDEVICE_PHONE_KEY_D                             = 0xBF
    /* Reserved                                                                 = 0xC0-0xFFFF */
} USB_HID_TELEPHONY_CTRLDEVICE;
...
typedef enum
{
    USB_HID_WEIGHING_CTRLDEVICES_UNDEFINED                                  = 0x00,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHING_CTRLDEVICES                           = 0x01,
    /* Reserved                                                         = 0x02-0x1F */
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CTRLDEVICE                               = 0x20,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_I_METRIC                       = 0x21,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_I_METRIC_SEL                   = 0x22,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_II_METRIC                      = 0x23,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_III_METRIC                     = 0x24,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_IIIL_METRIC                    = 0x25,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_IV_METRIC                      = 0x26,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_III_ENGLISH                    = 0x27,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_IIIL_ENGLISH                   = 0x28,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_IV_ENGLISH                     = 0x29,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CLASS_GENERIC                        = 0x2A,
    /* Reserved                                                         = 0x2B-0x2F */
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_ATTRIBUTE_REPORT                     = 0x30,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_CONTROL_REPORT                       = 0x31,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_DATA_REPORT                          = 0x32,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_REPORT                        = 0x33,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_WEIGHT_LIMIT_REPORT                  = 0x34,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATISTICS_REPORT                    = 0x35,
    /* Reserved                                                         = 0x36-0x3F */
    USB_HID_WEIGHING_CTRLDEVICES_DATA_WEIGHT                                = 0x40,
    USB_HID_WEIGHING_CTRLDEVICES_DATA_SCALING                               = 0x41,
    /* Reserved                                                         = 0x42-0x4F */
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT                                = 0x50,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_MILLIGRAM                      = 0x51,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_GRAM                           = 0x52,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_KILOGRAM                       = 0x53,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_CARATS                         = 0x54,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_TAELS                          = 0x55,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_GRAINS                         = 0x56,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_PENNYWEIGHTS                   = 0x57,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_METRIC_TON                     = 0x58,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_AVOIR_TON                      = 0x59,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_TROY_OUNCE                     = 0x5A,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_OUNCE                          = 0x5B,
    USB_HID_WEIGHING_CTRLDEVICES_WEIGHT_UNIT_POUND                          = 0x5C,
    /* Reserved                                                         = 0x5D-0x5F */
    USB_HID_WEIGHING_CTRLDEVICES_CALIBRATION_COUNT                          = 0x60,
    USB_HID_WEIGHING_CTRLDEVICES_REZERO_COUNT                               = 0x61,
    /* Reserved                                                         = 0x62-0x6F */
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS                               = 0x70,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_FAULT                         = 0x71,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_STABLE_AT_CENTER_OF_ZERO      = 0x72,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_IN_MOTION                     = 0x73,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_WEIGHT_STABLE                 = 0x74,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_UNDER_ZERO                    = 0x75,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_OVER_WEIGHT_LIMIT             = 0x76,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_REQUIRES_CALIBRATION          = 0x77,
    USB_HID_WEIGHING_CTRLDEVICES_SCALE_STATUS_REQUIRES_REZEROING            = 0x78,
    /* Reserved                                                         = 0x79-0x7F */
    USB_HID_WEIGHING_CTRLDEVICES_ZERO_SCALE                                 = 0x80,
    USB_HID_WEIGHING_CTRLDEVICES_ENFORCED_ZERO_RETURN                       = 0x81
    /* Reserved                                                         = 0x82-0xFFFF */
} USB_HID_WEIGHING_CTRLDEVICES;

typedef enum
{
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_UNDEFINED                   = 0x00,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_MSR_CTRLDEVICE_READ_ONLY        = 0x01,
    /* Reserved                                                         = 0x02-0x10 */
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_1_LENGTH              = 0x11,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_2_LENGTH              = 0x12,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_3_LENGTH              = 0x13,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_JIS_LENGTH            = 0x14,
    /* Reserved                                                         = 0x15-0x1F */
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_DATA                  = 0x20,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_1_DATA                = 0x21,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_2_DATA                = 0x22,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_3_DATA                = 0x23,
    USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES_TRACK_JIS_DATA              = 0x24
    /* Reserved                                                         = 0x25-0xFFFF */
} USB_HID_MAGNETIC_STRIPE_READING_CTRLDEVICES;

typedef enum
{
    USB_HID_POWER_CTRLDEVICE_UNDEFINED                                      = 0x00,
    USB_HID_POWER_CTRLDEVICE_INAME                                          = 0x01,
    USB_HID_POWER_CTRLDEVICE_PRESENT_STATUS                                 = 0x02,
    USB_HID_POWER_CTRLDEVICE_CHANGED_STATUS                                 = 0x03,
    USB_HID_POWER_CTRLDEVICE_UPS                                            = 0x04,
    USB_HID_POWER_CTRLDEVICE_POWER_SUPPLY                                   = 0x05,
    /* Reserved                                                         = 0x06-0x0F */
    USB_HID_POWER_CTRLDEVICE_BATTERY_SYSTEM                                 = 0x10,
    USB_HID_POWER_CTRLDEVICE_BATTERY_SYSTEM_ID                              = 0x11,
    USB_HID_POWER_CTRLDEVICE_BATTERY                                        = 0x12,
    USB_HID_POWER_CTRLDEVICE_BATTERY_ID                                     = 0x13,
    USB_HID_POWER_CTRLDEVICE_CHARGER                                        = 0x14,
    USB_HID_POWER_CTRLDEVICE_CHARGER_ID                                     = 0x15,
    USB_HID_POWER_CTRLDEVICE_POWER_CONVERTER                                = 0x16,
    USB_HID_POWER_CTRLDEVICE_POWER_CONVERTER_ID                             = 0x17,
    USB_HID_POWER_CTRLDEVICE_OUTLET_SYSTEM                                  = 0x18,
    USB_HID_POWER_CTRLDEVICE_OUTLET_SYSTEM_ID                               = 0x19,
    USB_HID_POWER_CTRLDEVICE_INPUT                                          = 0x1A,
    USB_HID_POWER_CTRLDEVICE_INPUT_ID                                       = 0x1B,
    USB_HID_POWER_CTRLDEVICE_OUTPUT                                         = 0x1C,
    USB_HID_POWER_CTRLDEVICE_OUTPUT_ID                                      = 0x1D,
    USB_HID_POWER_CTRLDEVICE_FLOW                                           = 0x1E,
    USB_HID_POWER_CTRLDEVICE_FLOW_ID                                        = 0x1F,
    USB_HID_POWER_CTRLDEVICE_OUTLET                                         = 0x20,
    USB_HID_POWER_CTRLDEVICE_OUTLET_ID                                      = 0x21,
    USB_HID_POWER_CTRLDEVICE_GANG                                           = 0x22,
    USB_HID_POWER_CTRLDEVICE_GANG_ID                                        = 0x23,
    USB_HID_POWER_CTRLDEVICE_POWER_SUMMARY                                  = 0x24,
    USB_HID_POWER_CTRLDEVICE_POWER_SUMMARY_ID                               = 0x25,
    /* Reserved                                                         = 0x26-0x2F */
    USB_HID_POWER_CTRLDEVICE_VOLTAGE                                        = 0x30,
    USB_HID_POWER_CTRLDEVICE_CURRENT                                        = 0x31,
    USB_HID_POWER_CTRLDEVICE_FREQUENCY                                      = 0x32,
    USB_HID_POWER_CTRLDEVICE_APPARENT_POWER                                 = 0x33,
    USB_HID_POWER_CTRLDEVICE_ACTIVE_POWER                                   = 0x34,
    USB_HID_POWER_CTRLDEVICE_PERCENT_LOAD                                   = 0x35,
    USB_HID_POWER_CTRLDEVICE_TEMPERATURE                                    = 0x36,
    USB_HID_POWER_CTRLDEVICE_HUMIDITY                                       = 0x37,
    USB_HID_POWER_CTRLDEVICE_BAD_COUNT                                      = 0x38,
    /* Reserved                                                         = 0x39-0x3F */
    USB_HID_POWER_CTRLDEVICE_CONFIG_VOLTAGE                                 = 0x40,
    USB_HID_POWER_CTRLDEVICE_CONFIG_CURRENT                                 = 0x41,
    USB_HID_POWER_CTRLDEVICE_CONFIG_FREQUENCY                               = 0x42,
    USB_HID_POWER_CTRLDEVICE_CONFIG_APPARENT_POWER                          = 0x43,
    USB_HID_POWER_CTRLDEVICE_CONFIG_ACTIVE_POWER                            = 0x44,
    USB_HID_POWER_CTRLDEVICE_CONFIG_PERCENT_LOAD                            = 0x45,
    USB_HID_POWER_CTRLDEVICE_CONFIG_TEMPERATURE                             = 0x46,
    USB_HID_POWER_CTRLDEVICE_CONFIG_HUMIDITY                                = 0x47,
    /* Reserved                                                         = 0x48-0x4F */
    USB_HID_POWER_CTRLDEVICE_SWITCH_ON_CONTROL                              = 0x50,
    USB_HID_POWER_CTRLDEVICE_SWITCH_OFF_CONTROL                             = 0x51,
    USB_HID_POWER_CTRLDEVICE_TOGGLE_CONTROL                                 = 0x52,
    USB_HID_POWER_CTRLDEVICE_LOW_VOLTAGE_TRANSFER                           = 0x53,
    USB_HID_POWER_CTRLDEVICE_HIGH_VOLTAGE_TRANSFER                          = 0x54,
    USB_HID_POWER_CTRLDEVICE_DELAY_BEFORE_REBOOT                            = 0x55,
    USB_HID_POWER_CTRLDEVICE_DELAY_BEFORE_STARTUP                           = 0x56,
    USB_HID_POWER_CTRLDEVICE_DELAY_BEFORE_SHUTDOWN                          = 0x57,
    USB_HID_POWER_CTRLDEVICE_TEST                                           = 0x58,
    USB_HID_POWER_CTRLDEVICE_MODULE_RESET                                   = 0x59,
    USB_HID_POWER_CTRLDEVICE_AUDIBLE_ALARM_CONTROL                          = 0x5A,
    /* Reserved                                                         = 0x5B-0x5F */
    USB_HID_POWER_CTRLDEVICE_PRESENT                                        = 0x60,
    USB_HID_POWER_CTRLDEVICE_GOOD                                           = 0x61,
    USB_HID_POWER_CTRLDEVICE_INTERNAL_FAILURE                               = 0x62,
    USB_HID_POWER_CTRLDEVICE_VOLTAGE_OUT_OF_RANGE                           = 0x63,
    USB_HID_POWER_CTRLDEVICE_FREQUENCY_OUT_OF_RANGE                         = 0x64,
    USB_HID_POWER_CTRLDEVICE_OVERLOAD                                       = 0x65,
    USB_HID_POWER_CTRLDEVICE_OVER_CHARGED                                   = 0x66,
    USB_HID_POWER_CTRLDEVICE_OVER_TEMPERATURE                               = 0x67,
    USB_HID_POWER_CTRLDEVICE_SHUTDOWN_REQUESTED                             = 0x68,
    USB_HID_POWER_CTRLDEVICE_SHUTDOWN_IMMINENT                              = 0x69,
    /* Reserved                                                         = 0x6A */
    USB_HID_POWER_CTRLDEVICE_SWITCH_ON_OFF                                  = 0x6B,
    USB_HID_POWER_CTRLDEVICE_SWITCHABLE                                     = 0x6C,
    USB_HID_POWER_CTRLDEVICE_USED                                           = 0x6D,
    USB_HID_POWER_CTRLDEVICE_BOOST                                          = 0x6E,
    USB_HID_POWER_CTRLDEVICE_BUCK                                           = 0x6F,
    USB_HID_POWER_CTRLDEVICE_INITIALIZED                                    = 0x70,
    USB_HID_POWER_CTRLDEVICE_TESTED                                         = 0x71,
    USB_HID_POWER_CTRLDEVICE_AWAITING_POWER                                 = 0x72,
    USB_HID_POWER_CTRLDEVICE_COMMUNICATION_LOST                             = 0x73,
    /* Reserved                                                         = 0x74-0xFC */
    USB_HID_POWER_CTRLDEVICE_IMANUFACTURER                                  = 0xFD,
    USB_HID_POWER_CTRLDEVICE_IPRODUCT                                       = 0xFE,
    USB_HID_POWER_CTRLDEVICE_ISERIAL_NUMBER                                 = 0xFF
} USB_HID_POWER_CTRLDEVICE;
...
typedef enum
{
    ...
    USB_HID_BATTERY_SYSTEM_ICTRLDEVICE_NAME                                 = 0x88,
    USB_HID_BATTERY_SYSTEM_ICTRLDEVICE_CHEMISTERY                           = 0x89,
