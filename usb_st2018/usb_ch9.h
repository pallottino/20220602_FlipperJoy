...
#define USB_DESCRIPTOR_CTRLDEVICE           0x01    // bDescriptorType for a Device Descriptor.
#define USB_DESCRIPTOR_CONFIGURATION    0x02    // bDescriptorType for a Configuration Descriptor.
#define USB_DESCRIPTOR_STRING           0x03    // bDescriptorType for a String Descriptor.
#define USB_DESCRIPTOR_INTERFACE        0x04    // bDescriptorType for an Interface Descriptor.
#define USB_DESCRIPTOR_ENDPOINT         0x05    // bDescriptorType for an Endpoint Descriptor.
#define USB_DESCRIPTOR_CTRLDEVICE_QUALIFIER 0x06    // bDescriptorType for a Device Qualifier.
...
*/
typedef struct PACKED _USB_CTRLDEVICE_DESCRIPTOR
{
    uint8_t bLength;               // Length of this descriptor.
    uint8_t bDescriptorType;       // CTRLDEVICE descriptor type (USB_DESCRIPTOR_CTRLDEVICE).
...
typedef struct PACKED _USB_CTRLDEVICE_QUALIFIER_DESCRIPTOR
{
    uint8_t bLength;               // Size of this descriptor
    uint8_t bType;                 // Type, always USB_DESCRIPTOR_CTRLDEVICE_QUALIFIER
...
} USB_CTRLDEVICE_QUALIFIER_DESCRIPTOR;
...
typedef union PACKED
{
    ...
    struct PACKED
    {
        ...
        unsigned :8;
        uint8_t bFeature;          //CTRLDEVICE_REMOTE_WAKEUP,ENDPOINT_HALT
        unsigned :8;
        unsigned :8;
        unsigned :8;
        unsigned :8;
...
#define USB_FEATURE_CTRLDEVICE_REMOTE_WAKEUP        1       // CLEAR/SET FEATURE - Device remote wake-up
#define USB_FEATURE_TEST_MODE                   2       // CLEAR/SET FEATURE - Test mode

// Section: Setup Data Constants

#define USB_SETUP_HOST_TO_CTRLDEVICE                0x00    // Device Request bmRequestType transfer direction - host to device transfer
#define USB_SETUP_CTRLDEVICE_TO_HOST                0x80    // Device Request bmRequestType transfer direction - device to host transfer
#define USB_SETUP_TYPE_STANDARD                 0x00    // Device Request bmRequestType type - standard
#define USB_SETUP_TYPE_CLASS                    0x20    // Device Request bmRequestType type - class
#define USB_SETUP_TYPE_VENDOR                   0x40    // Device Request bmRequestType type - vendor
#define USB_SETUP_RECIPIENT_CTRLDEVICE              0x00    // Device Request bmRequestType recipient - device
#define USB_SETUP_RECIPIENT_INTERFACE           0x01    // Device Request bmRequestType recipient - interface
#define USB_SETUP_RECIPIENT_ENDPOINT            0x02    // Device Request bmRequestType recipient - endpoint
#define USB_SETUP_RECIPIENT_OTHER               0x03    // Device Request bmRequestType recipient - other

#define USB_SETUP_HOST_TO_CTRLDEVICE_BITFIELD       (USB_SETUP_HOST_TO_CTRLDEVICE>>7)       // Device Request bmRequestType transfer direction - host to device transfer - bit definition
#define USB_SETUP_CTRLDEVICE_TO_HOST_BITFIELD       (USB_SETUP_CTRLDEVICE_TO_HOST>>7)       // Device Request bmRequestType transfer direction - device to host transfer - bit definition
...
#define USB_SETUP_RECIPIENT_CTRLDEVICE_BITFIELD     (USB_SETUP_RECIPIENT_CTRLDEVICE)        // Device Request bmRequestType recipient - device
...
#define USB_FEATURE_CTRLDEVICE_REMOTE_WAKEUP        1       // Device recipient
